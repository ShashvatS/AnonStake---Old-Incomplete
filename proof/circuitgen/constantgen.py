...
file.write("hashconstant " + str(secrets.randbits(256) % prime_r) + "\n")

for cipher in cipherlist:
    constants = [secrets.randbits(256) % prime_r for i in range(MIMC_ROUNDS - 1)]
    data = [cipher] + ["0"] + [str(i) for i in constants] + ["\n"]
